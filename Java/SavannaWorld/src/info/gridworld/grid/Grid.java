...
public interface Grid<E>
{
    ...
    /**
     * Gets the locations in this grid that contain objects, sorted by distance from a given location
     * @param loc location to sort distance by
     * @return a list of all occupied locations in this grid, sorted by distance from loc
     */
    List<Location> getOccupiedLocationsByDistance(Location loc);
    ...
    /**
     * Gets the rectilinear distance between two locations. ie, difference between x value + distance between y value
     * @param loc1
     * @param loc2
     * @return
     */
